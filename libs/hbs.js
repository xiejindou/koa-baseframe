module.exports = function (hbs) {
    ...
    // 比较两个变量是否相等
    hbs.registerHelper('noteq', function (left, right, options) {
        if (arguments.length !== 3) {
            throw new Error('helper "eq" needs 2 arguments');
        }
        if (left !== right) {
    ...
    // 比较第一个变量是否大于第二个
    hbs.registerHelper('gt', function (left, right, options) {
        if (arguments.length !== 3) {
    ...
    // 比较第一个变量是否大于等于第二个
    hbs.registerHelper('gte', function (left, right, options) {
        if (arguments.length !== 3) {
    ...
    // 比较第一个变量是否小于第二个
    hbs.registerHelper('lt', function (left, right, options) {
        if (arguments.length !== 3) {
    ...
    // 比较第一个变量是否小于等于第二个
    hbs.registerHelper('lte', function (left, right, options) {
        if (arguments.length !== 3) {
    ...
    // 判断一个整数是否为偶数
    hbs.registerHelper('even', function (num, options) {
    ...
    // 判断一个整数是否为奇数
    hbs.registerHelper('odd', function (num, options) {
        if (arguments.length !== 2) {
     ...
     **/
    hbs.registerHelper('multiple', function (num, base, options) {
        if (arguments.length !== 3) {
