...
_e(function (E, $) {
     ...
     E.UI.menus = {
        ...
        link: {
            normal: '<a href="#" tabindex="-1"><img src="/img/upimg.png" class="wangeditor-menu-img-link upimg">&nbsp<span class="upspan">插入商品</span></a>',
            selected: '.selected'
        },
        unlink: {
        ...
        img: {
            // <i class="></i>
            normal: '<a href="#" tabindex="-1"><img src="/img/upimg.png" class="wangeditor-menu-img-picture upimg">&nbsp<span class="upspan">插入图片</span></a>',
            selected: '.selected'
        },
        video: {
...
_e(function (E, $) {
    ...
    UploadFile.fn.render = function () {
        ...
        var $input = $('<input name="pic" type="file" ' + acceptTpl + ' ' + multipleTpl + '/>');
...
_e(function (E, $) {
    ...
    UploadFile.fn.render = function () {
        ...
        var multipleTpl = multiple ? 'multiple="multiple"' : '';
        var $p = $('<p>选择图片并上传</p>');
        var $input = $('<input type="file" ' + multipleTpl + ' name="pic"/>');
