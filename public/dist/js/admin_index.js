var h = $(window).height();
$("body").height(h);
var releaseChart, payChart, commentChart, readChart, option;
Vue.component('count', {
    template: '#main',
    data: function () {
        return {
    ...
    methods: {
        ...
        chart_xdata(i) {
            switch (i) {
                case 0:
                    this.seclect_day = 'day';return this.daydata;break;
                case 1:
                    this.seclect_day = 'week';return this.weekdata;break;
                case 2:
                    this.seclect_day = 'month';return this.monthdata;break;
            }
        },
        //获取数据
        getdata() {
